 ...
 * @author hp
 */
public class DisplayRecordWithTableGUI extends JFrame {
    ...
    public DisplayRecordWithTableGUI(String name) {
        setTitle("Records");
...
//            @Override
//            public void run() {
//                DisplayRecordWithTableGUI gui = new DisplayRecordWithTableGUI();
//
//                gui.setVisible(true);
//            }
//
